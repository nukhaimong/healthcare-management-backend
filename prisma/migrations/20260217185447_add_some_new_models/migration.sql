/*
  ...
  - You are about to alter the column `title` on the `specialties` table. The data in that column could be lost. The data in that column will be cast from `VarChar(225)` to `VarChar(100)`.
...
-- RenameIndex
ALTER INDEX "idx_doctor_idDeleted" RENAME TO "idx_doctor_isDeleted";

-- RenameIndex
ALTER INDEX "idx,_specialty_idDeleted" RENAME TO "idx_specialty_isDeleted";
